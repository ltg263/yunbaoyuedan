...
public class VoiceRecordDialogFragment extends AbsDialogFragment implements View.OnClickListener {
    ...
    private void confirm(){
        ...
        if(onDataListnter!=null){
           onDataListnter.data(mVoiceFile,mCurTime);
        }
        dismiss();
    }


    private OnDataListnter onDataListnter;

    public void setOnDataListnter(OnDataListnter onDataListnter) {
        this.onDataListnter = onDataListnter;
    }

    public interface OnDataListnter{
