package com.yunbao.dynamic.util;
...
public class CommentTextRender {
    ...
    public static ForegroundColorSpan getsColorSpan1() {
        return sColorSpan1;
    }
    ...
    public static CharSequence renderDynamicComment(CharSequence content,int userNameStartIndex,int userNameEndIndex, String addTime) {
        SpannableStringBuilder builder = new SpannableStringBuilder(content);
        ...
        if(userNameEndIndex!=-1){
           builder.setSpan(sColorSpan1, userNameStartIndex, userNameEndIndex, Spannable.SPAN_EXCLUSIVE_EXCLUSIVE);
        }
