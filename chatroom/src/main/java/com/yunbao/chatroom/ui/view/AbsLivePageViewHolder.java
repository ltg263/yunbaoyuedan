...
public abstract class AbsLivePageViewHolder extends AbsViewHolder2 implements View.OnClickListener {
    ...
    public void init() {
        ...
        findViewById(com.yunbao.common.R.id.btn_back).setOnClickListener(this);
    }
    ...
    public void onClick(View v) {
        int i = v.getId();
        if (i == com.yunbao.common.R.id.btn_back) {
            hide();
        }
    }
