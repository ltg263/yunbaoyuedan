...
public class LiveSongHostActivity extends LiveSongActivity {
    ...
    public static void forward(Context context, LiveBean liveBean){
        Intent intent=new Intent(context, LiveSongHostActivity.class);
    ...
    public void applySinger(UserBean userBean, int sitId) {
        showApplySingerDialog(userBean,sitId);
    }



    private void showApplySingerDialog(UserBean userBean, int sitId) {
        ApplySingerResultDialogFragment singerResultDialogFragment=new ApplySingerResultDialogFragment();
        singerResultDialogFragment.setSingerBean(userBean,Integer.toString(sitId));
        singerResultDialogFragment.show(getSupportFragmentManager());
    }
}
