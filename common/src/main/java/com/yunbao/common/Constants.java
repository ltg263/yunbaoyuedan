...
public class Constants {
    ...
    public static final String PAY_TYPE_PAYPAL = "6";//paypal
    ...
    public static final int MAIN_ME_ORDER = 1;//订单中心
    public static final int MAIN_ME_WALLET = 2;//我的钱包
    public static final int MAIN_ME_AUTH = 3;//实名认证
    public static final int MAIN_ME_AUTH_SKILL = 4;//申请大神
    public static final int MAIN_ME_MY_SKILL = 5;//我的技能
    public static final int MAIN_ME_SETTING = 6;//设置
    public static final int MAIN_ME_DYNAMICS = 7;//动态
    public static final int MAIN_ME_PHOTO = 8;//相册
    public static final int MAIN_ME_APPLY_ROOM = 10;//进入申请界面
    public static final int MAIN_ME_ROOM = 11;//开启聊天室
    public static final int MAIN_ME_BONUS = 13;//每日签到
    ...
    public static final int STATE_PREPARATION_LINK=1; //准备环节
    public static final int STATE_CARDIAC_SELECTION=2;//心动选择
    public static final int STATE_ANNOUNCE_HEARTBEAT=3;//公布心动
    ...
    public static final String PAYPAL_PAYMENT_CURRENCY_TYPE = "USD";//PayPal支付货币类型
