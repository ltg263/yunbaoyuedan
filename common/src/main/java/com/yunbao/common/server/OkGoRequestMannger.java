...
public class OkGoRequestMannger implements IRequestManager {
    ...
    @Override
    public <T> Observable<List<T>> getAndShowMsg(String url, Map<String, Object> map, Class<T> cs) {
        return CommonHttpUtil.getAndShowMsg(url,parse(map),cs);
    }
    ...
    public Observable<Boolean> noReturnPost(String url, Map<String, Object> map) {
        return CommonHttpUtil.postNoReturn(url,parse(map));
    }

    @Override
    public Observable<BaseResponse<JSONObject>> postNormal(String url, Map<String, Object> map) {
        return CommonHttpUtil.postNormal(url,parse(map));
    }
