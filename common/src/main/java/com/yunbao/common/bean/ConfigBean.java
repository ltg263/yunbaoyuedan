...
public class ConfigBean {
    ...
    private String admin_dispatch;
    private String admin_upservice; //跟新立即服务状态
    private String mAdInfo;//引导页 广告信息
    private String mImTeenagerTip;
    private String teenager_des;//青少年模式提示语
    private int mLeaderBoardSwitch; //排行榜开关


    private String admin;

    private String dripAdmin;

    private String orderHallAdmin;
    ...
    //滴滴订单
    @JSONField(name = "im_admin_drip")
    public String getDripAdmin() {
        return dripAdmin;
    }
    //滴滴订单
    @JSONField(name = "im_admin_drip")
    public void setDripAdmin(String dripAdmin) {
        this.dripAdmin = dripAdmin;
    }
    //抢单大厅
    @JSONField(name = "im_admin_driplist")
    public String getOrderHallAdmin() {
        return orderHallAdmin;
    }
    //抢单大厅
    @JSONField(name = "im_admin_driplist")
    public void setOrderHallAdmin(String orderHallAdmin) {
        this.orderHallAdmin = orderHallAdmin;
    }

    public String getAdmin_dispatch() {
        return admin_dispatch;
    }

    public void setAdmin_dispatch(String admin_dispatch) {
        this.admin_dispatch = admin_dispatch;
    }

    public String getAdmin_upservice() {
        return admin_upservice;
    }

    public void setAdmin_upservice(String admin_upservice) {
        this.admin_upservice = admin_upservice;
    }
    ...
    @JSONField(name = "im_teenager_tips")
    public String getImTeenagerTip() {
        return mImTeenagerTip;
    }

    @JSONField(name = "im_teenager_tips")
    public void setImTeenagerTip(String imTeenagerTip) {
        mImTeenagerTip = imTeenagerTip;
    }

    @JSONField(name = "teenager_des")
    ...
    @JSONField(name = "leaderboard_switch")
    public int getLeaderBoardSwitch() {
        return mLeaderBoardSwitch;
    }

    @JSONField(name = "leaderboard_switch")
    public void setLeaderBoardSwitch(int leaderBoardSwitch) {
        mLeaderBoardSwitch = leaderBoardSwitch;
    }
}
