...
/**
 * Created by Sky.L on 2021-07-17
 */
public class LadderTextView extends android.support.v7.widget.AppCompatTextView {
    ...
    private Drawable selectedBg;//背景
    ...
    private void initAttributes(Context context, AttributeSet attrs) {
        ...
        selectedBg = typedArray.getDrawable(R.styleable.LadderTextView_selectedBg);
        typedArray.recycle();
    }
...
//                    sendEmptyMessageDelayed(0, 1000);
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (isLeft) {
            ...
            linePath.close();
            LinearGradient lg=new LinearGradient(0,0,(int) (width - offsetScale * height),height - lineOffset,Color.parseColor("#fb7342"),Color.parseColor("#fbae45"), Shader.TileMode.MIRROR);
            paint.setShader(lg);
