...
public class WxPayBuilder {
    ...
    public void pay2(String partnerId,String prepayId,String packageValue,String nonceStr,String timeStamp,String sign){
        ...
        L.e("pay2pay2____mAppId=="+mAppId+"===partnerId=="+partnerId+"====prepayId=="
                +prepayId+"===packageValue==="+packageValue+"=====nonceStr==="+nonceStr+"=====timeStamp==="
                +timeStamp+"====sign===="+sign);
        ...
        CommonHttpUtil.getWxOrder(mOrderParams, new HttpCallback() {
            ...
            public void onSuccess(int code, String msg, String[] info) {
                if (code == 0 && info.length > 0) {
                    JSONObject obj = JSON.parseObject(info[0]).getJSONObject("wx");
