...
import com.yunbao.common.pay.google.GooglePayTask;
...
public class PayPresenter {
    ...
    public void pay2(String payType, String money, String goodsName, String orderParams,String orderId) {
        if (TextUtils.isEmpty(payType)) {
            ToastUtil.show(R.string.wallet_tip_5);
            return;
        }
        switch (payType) {
            case Constants.PAY_TYPE_ALI://支付宝支付
                aliPay2(money, goodsName, orderParams,orderId);
                break;
//            case Constants.PAY_TYPE_WX://微信支付
//                wxPay2();
//                break;
     ...
     * 支付宝支付
     */
    private void aliPay2(String money, String goodsName, String orderParams,String orderId) {
     ...
     * 微信支付
     */
    public void wxPay2(String partnerId,String prepayId,String packageValue,String nonceStr,String timeStamp,String sign) {
        if (mActivity == null || mPayCallback == null) {
            return;
        }
        if (!CommonAppConfig.isAppExist(Constants.PACKAGE_NAME_WX)) {
            ToastUtil.show(R.string.coin_wx_not_install);
        ...
        WxPayBuilder builder = new WxPayBuilder(mActivity, mWxAppID);
        builder.setPayCallback(mPayCallback);
        builder.pay2(partnerId,prepayId,packageValue,nonceStr,timeStamp,sign);
    }
