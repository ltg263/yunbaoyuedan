 ...
 * @author apple
 */
public class MainRecommendDynamicViewHolder extends AbsMainHomeChildViewHolder {
    ...
    public MainRecommendDynamicViewHolder(Context context, ViewGroup parentView, Object... args) {
    ...
    public Observable<List<MyDynamicBean>> getData(int p) {
        ...
        return DynamicHttpUtil.getDynamicRecom(dressingCommitBean.getSex(),dressingCommitBean.getAge(),dressingCommitBean.getSkill(),p)
                .compose(appCompatActivity.<List<MyDynamicBean>>bindToLifecycle());
    }
