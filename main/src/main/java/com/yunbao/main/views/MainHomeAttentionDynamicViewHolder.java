...
public abstract class MainHomeAttentionDynamicViewHolder extends AbsMainHomeChildViewHolder {
    ...
    public MainHomeAttentionDynamicViewHolder(Context context, ViewGroup parentView) {
    ...
    public void init() {
        ...
        adapter.setOnItemClickListener(new BaseQuickAdapter.OnItemClickListener() {
            ...
            public void onItemClick(BaseQuickAdapter adapter, View view, int position) {
                DynamicUserBean bean= MainHomeAttentionDynamicViewHolder.this.adapter.getArray().get(position);
        ...
        mRefreshView.setEmptyLayoutId(R.layout.view_no_data_main_home_follow);
