...
public class MainNewestDynamicViewHolder extends AbsMainHomeChildViewHolder {
    ...
    public MainNewestDynamicViewHolder(Context context, ViewGroup parentView, Object... args) {
    ...
    public Observable<List<MyDynamicBean>> getData(int p) {
        ...
        return DynamicHttpUtil.getDynamicNew(dressingCommitBean.getSex(), dressingCommitBean.getAge(), dressingCommitBean.getSkill(), p)
