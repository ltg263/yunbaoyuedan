...
public class MainFollowDynamicViewHolder extends AbsMainHomeChildViewHolder {
    ...
    public MainFollowDynamicViewHolder(Context context, ViewGroup parentView, Object... args) {
    ...
    public Observable<List<MyDynamicBean>> getData(int p) {
       ...
       // return DynamicHttpUtil.getMyDynamic(p).compose(appCompatActivity.<List<MyDynamicBean>>bindToLifecycle());
        return DynamicHttpUtil.getDynamicFollow(dressingCommitBean.getSex(),dressingCommitBean.getAge(),dressingCommitBean.getSkill(),p)
