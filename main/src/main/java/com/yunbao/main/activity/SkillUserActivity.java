...
public class SkillUserActivity extends AbsActivity implements OnItemClickListener<SkillUserBean>, View.OnClickListener {

    public static void forward(Context context, SkillClassBean bean) {
        Intent intent = new Intent(context, SkillUserActivity.class);
    ...
    @Override
    protected void main() {
        SkillClassBean gameBean = getIntent().getParcelableExtra(Constants.SKILL_BEAN);
        if (gameBean != null) {
            mGameId = gameBean.getId();
        ...
        mRefreshView.setDataHelper(new CommonRefreshView.DataHelper<SkillUserBean>() {
            ...
            public RefreshAdapter<SkillUserBean> getAdapter() {
                if (mAdapter == null) {
                    ...
                    mAdapter.setOnItemClickListener(SkillUserActivity.this);
                }
                return mAdapter;
            }
    ...
    protected void onDestroy() {
        ...
        if (mPop1 != null) {
            ...
            mPop1.setOnDismissListener(null);
            mPop1 = null;
        }
        if (mPop2 != null) {
            if (mPop2.isShowing()) {
            ...
            mPop2.setOnDismissListener(null);
            mPop2 = null;
        }
        if (mPop3 != null) {
            if (mPop3.isShowing()) {
            ...
            mPop3.setOnDismissListener(null);
            mPop3 = null;
        }
        super.onDestroy();
    }
