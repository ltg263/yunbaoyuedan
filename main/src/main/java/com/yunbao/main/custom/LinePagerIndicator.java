...
public class LinePagerIndicator extends View implements IPagerIndicator {
    ...
    public void onPageScrolled(int position, float positionOffset, int positionOffsetPixels) {
        ...
        int colorStart = getResources().getColor(R.color.light_blue);
        int colorEnd = getResources().getColor(R.color.global);
        if(backGradient==null){
            backGradient = new LinearGradient(0, 0, DpUtil.dp2px(width/2), height, new int[]{colorStart,colorEnd}, null, Shader.TileMode.MIRROR);
