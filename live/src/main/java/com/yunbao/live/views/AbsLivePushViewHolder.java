...
public abstract class AbsLivePushViewHolder extends AbsViewHolder implements ILivePushViewHolder {
    ...
    public void setLiveStickerGift(String stickerGiftId, long playTime) {
        ...
        if (mIsPlayGiftSticker) {
            ...
            showSticker(bean.getName(),bean.getResource(), playTime);
        }
    }
     ...
     * 道具礼物贴纸
     */
    private void showSticker(final String stickerName,final String resource, final long playTime) {
    ...
    private void playSticker(String stickerName, long playTime) {
        ...
        MhDataManager.getInstance().setTieZhi(stickerName, MHConfigConstants.TIE_ZHI_2);
        if (mHandler == null) {
    ...
    private void getNextStickerGift() {
        if (mQueue != null) {
            ...
            if (nextGiftBean == null) {
                ...
                showSticker(nextGiftBean.getName(), nextGiftBean.getResource(),nextGiftBean.getPlayTime());
            }
        } else {
            endSticker();
        }
    ...
    private void endSticker() {
        if (mIsPlayGiftSticker) {
            ...
            MhDataManager.getInstance().setTieZhi("",MHConfigConstants.TIE_ZHI_2);
