...
//        implements KSYStreamer.OnInfoListener, KSYStreamer.OnErrorListener, StatsLogReport.OnLogEventListener
{
...
//                        KsyMhFilter mhFilter = new KsyMhFilter(MhDataManager.getInstance().getMhManager(),null /*mStreamer.getGLRender()*/);
