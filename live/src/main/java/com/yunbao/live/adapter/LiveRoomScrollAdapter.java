...
public class LiveRoomScrollAdapter extends RecyclerView.Adapter<LiveRoomScrollAdapter.Vh> {
    ...
    private List<LiveBeanReal> mList;
    ...
    public LiveRoomScrollAdapter(Context context, List<LiveBeanReal> list, int curPosition) {
        mContext = context;
        mList = list;
    ...
    class Vh extends RecyclerView.ViewHolder {
        ...
        void setData(LiveBeanReal bean, int position) {
            mLiveBean = bean;
...
//                    }
    ...
    public interface ActionListener {
        void onPageSelected(LiveBeanReal liveBean, ViewGroup container, boolean first);
