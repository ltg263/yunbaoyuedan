...
public class LiveHttpUtil {
    ...
    public static void getUserList(String liveuid, String stream, HttpCallback callback) {
       HttpClient.getInstance().get("Zlive.getUserLists", LiveHttpConsts.GET_USER_LIST)
    ...
    public static void roomCharge(String liveUid, String stream, HttpCallback callback) {
       HttpClient.getInstance().get("Zlive.roomCharge", LiveHttpConsts.ROOM_CHARGE)
    ...
    public static void timeCharge(String liveUid, String stream, HttpCallback callback) {
       HttpClient.getInstance().get("Zlive.timeCharge", LiveHttpConsts.TIME_CHARGE)
                .params("uid",CommonAppConfig.getInstance().getUid())
                .params("token",CommonAppConfig.getInstance().getToken())
                .params("stream", stream)
                .params("liveuid", liveUid)
    ...
    public static void getCoin(HttpCallback callback) {
       HttpClient.getInstance().get("Zlive.getCoin", LiveHttpConsts.GET_COIN)
                .params("uid",CommonAppConfig.getInstance().getUid())
                .params("token",CommonAppConfig.getInstance().getToken())
                .execute(callback);
    }
    ...
    public static void getAdminList(String liveUid, HttpCallback callback) {
       HttpClient.getInstance().get("Zlive.getAdminList", LiveHttpConsts.GET_ADMIN_LIST)
                .params("uid",CommonAppConfig.getInstance().getUid())
                .params("token",CommonAppConfig.getInstance().getToken())
                .params("liveuid", liveUid)
                .execute(callback);
    ...
    public static void setAdmin(String liveUid, String touid, HttpCallback callback) {
       HttpClient.getInstance().get("Zlive.setAdmin", LiveHttpConsts.SET_ADMIN)
                .params("uid",CommonAppConfig.getInstance().getUid())
                .params("token",CommonAppConfig.getInstance().getToken())
                .params("liveuid", liveUid)
                .params("touid", touid)
    ...
    public static void getLiveEndInfo(String stream, HttpCallback callback) {
       HttpClient.getInstance().get("Zlive.stopInfo", LiveHttpConsts.GET_LIVE_END_INFO)
                .params("stream", stream)
                .execute(callback);
    }
    ...
    public static void getLiveReportList(HttpCallback callback) {
       HttpClient.getInstance().get("Zlive.getReportClass", LiveHttpConsts.GET_LIVE_REPORT_LIST)
                .execute(callback);
    }
    ...
    public static void setReport(String touid, String content, HttpCallback callback) {
       HttpClient.getInstance().get("Zlive.setReport", LiveHttpConsts.SET_REPORT)
                .params("uid",CommonAppConfig.getInstance().getUid())
                .params("token",CommonAppConfig.getInstance().getToken())
                .params("touid", touid)
    ...
    public static void getLiveUser(String touid, String liveUid, HttpCallback callback) {
       HttpClient.getInstance().get("Zlive.getPop", LiveHttpConsts.GET_LIVE_USER)
                .params("uid",CommonAppConfig.getInstance().getUid())
                .params("touid", touid)
                .params("liveuid", liveUid)
                .execute(callback);
    ...
    public static void kicking(String liveUid, String touid, HttpCallback callback) {
       HttpClient.getInstance().get("Zlive.kicking", LiveHttpConsts.KICKING)
                .params("uid",CommonAppConfig.getInstance().getUid())
                .params("token",CommonAppConfig.getInstance().getToken())
                .params("liveuid", liveUid)
                .params("touid", touid)
    ...
    public static void setShutUp(String liveUid, String stream, int type, String touid, HttpCallback callback) {
       HttpClient.getInstance().get("Zlive.setShutUp", LiveHttpConsts.SET_SHUT_UP)
                .params("uid",CommonAppConfig.getInstance().getUid())
                .params("token",CommonAppConfig.getInstance().getToken())
                .params("liveuid", liveUid)
                .params("stream", stream)
    ...
    public static void superCloseRoom(String liveUid, int type, HttpCallback callback) {
       HttpClient.getInstance().get("Zlive.superStopRoom", LiveHttpConsts.SUPER_CLOSE_ROOM)
                .params("uid",CommonAppConfig.getInstance().getUid())
                .params("token",CommonAppConfig.getInstance().getToken())
                .params("liveuid", liveUid)
                .params("type", type)
    ...
    public static void getLinkMicStream(HttpCallback callback) {
       HttpClient.getInstance().get("Zlinkmic.RequestLVBAddrForLinkMic", LiveHttpConsts.GET_LINK_MIC_STREAM)
                .params("uid",CommonAppConfig.getInstance().getUid())
                .execute(callback);
    }
    ...
    public static void linkMicShowVideo(String touid, String pull_url) {
       HttpClient.getInstance().get("Zlive.showVideo", LiveHttpConsts.LINK_MIC_SHOW_VIDEO)
                .params("uid",CommonAppConfig.getInstance().getUid())
                .params("token",CommonAppConfig.getInstance().getToken())
    ...
    public static void setLinkMicEnable(boolean linkMicEnable, HttpCallback callback) {
       HttpClient.getInstance().get("Zlinkmic.setMic", LiveHttpConsts.SET_LINK_MIC_ENABLE)
                .params("uid",CommonAppConfig.getInstance().getUid())
                .params("token",CommonAppConfig.getInstance().getToken())
    ...
    public static void checkLinkMicEnable(String liveUid, HttpCallback callback) {
       HttpClient.getInstance().get("Zlinkmic.isMic", LiveHttpConsts.CHECK_LINK_MIC_ENABLE)
                .params("uid",CommonAppConfig.getInstance().getUid())
                .params("liveuid", liveUid)
                .execute(callback);
    }
    ...
    public static void livePkCheckLive(String liveUid, String stream, String uidStream, HttpCallback callback) {
       HttpClient.getInstance().get("Zlivepk.checkLive", LiveHttpConsts.LIVE_PK_CHECK_LIVE)
                .params("uid",CommonAppConfig.getInstance().getUid())
                .params("token",CommonAppConfig.getInstance().getToken())
                .params("liveuid", liveUid)
                .params("stream", stream)
    ...
    public static void sendDanmu(String content, String liveUid, String stream, HttpCallback callback) {
       HttpClient.getInstance().get("Zlive.sendBarrage", LiveHttpConsts.SEND_DANMU)
                .params("uid",CommonAppConfig.getInstance().getUid())
                .params("token",CommonAppConfig.getInstance().getToken())
                .params("liveuid", liveUid)
                .params("stream", stream)
    ...
    public static void checkLive(String liveUid, String stream, HttpCallback callback) {
       HttpClient.getInstance().get("Zlive.checkLive", LiveHttpConsts.CHECK_LIVE)
                .params("uid",CommonAppConfig.getInstance().getUid())
                .params("token",CommonAppConfig.getInstance().getToken())
                .params("liveuid", liveUid)
                .params("stream", stream)
    ...
    public static void enterRoom(String liveUid, String stream, HttpCallback callback) {
       HttpClient.getInstance().get("Zlive.enterRoom", LiveHttpConsts.ENTER_ROOM)
                .params("uid",CommonAppConfig.getInstance().getUid())
                .params("token",CommonAppConfig.getInstance().getToken())
    ...
    public static void getGiftList(int live_type, HttpCallback callback) {
       HttpClient.getInstance().get("Zlive.getGiftList", LiveHttpConsts.GET_GIFT_LIST)
                .params("uid",CommonAppConfig.getInstance().getUid())
                .params("token",CommonAppConfig.getInstance().getToken())
    ...
    public static void sendGift(String liveUid, String stream, int giftId, String giftCount,  HttpCallback callback) {
       HttpClient.getInstance().get("Zlive.sendGift", LiveHttpConsts.SEND_GIFT)
                .params("uid",CommonAppConfig.getInstance().getUid())
                .params("token",CommonAppConfig.getInstance().getToken())
                .params("liveuid", liveUid)
                .params("stream", stream)
    ...
    public static void livePkSearchAnchor(String key, int p, HttpCallback callback) {
       HttpClient.getInstance().get("Zlivepk.Search", LiveHttpConsts.LIVE_PK_SEARCH_ANCHOR)
                .params("uid",CommonAppConfig.getInstance().getUid())
                .params("key", key)
                .params("p", p)
                .execute(callback);
    ...
    public static void getLivePkList(int p, HttpCallback callback) {
       HttpClient.getInstance().get("Zlivepk.GetLiveList", LiveHttpConsts.GET_LIVE_PK_LIST)
                .params("uid",CommonAppConfig.getInstance().getUid())
                .params("token",CommonAppConfig.getInstance().getToken())
                .params("p", p)
                .execute(callback);
    ...
    public static void searchMusic(String key, HttpCallback callback) {
       HttpClient.getInstance().get("Zlivemusic.searchMusic", LiveHttpConsts.SEARCH_MUSIC)
                .params("key", key)
                .execute(callback);
    }
    ...
    public static void getMusicUrl(String musicId, HttpCallback callback) {
       HttpClient.getInstance().get("Zlivemusic.getDownurl", LiveHttpConsts.GET_MUSIC_URL)
    ...
    public static void createRoom(String title, int liveClassId, int type, String typeVal, int isShop, String thumb, boolean openLocation, boolean isVoiceRoom, HttpCallback callback) {
       ...
       HttpClient.getInstance().get("Zlive.createRoom", LiveHttpConsts.CREATE_ROOM)
                .params("uid", u.getId())
    ...
    public static void changeLive(String stream) {
       HttpClient.getInstance().get("Zlive.changeLive", LiveHttpConsts.CHANGE_LIVE)
                .params("uid",CommonAppConfig.getInstance().getUid())
                .params("token",CommonAppConfig.getInstance().getToken())
                .params("stream", stream)
                .params("status", "1")
    ...
    public static void stopLive(String stream, HttpCallback callback) {
       ...
       HttpClient.getInstance().get("Zlive.stopRoom", LiveHttpConsts.STOP_LIVE)
                .params("stream", stream)
                .params("uid", uid)
                .params("token",token)
                .params("time", time)
    ...
    public static void getLiveSdk(HttpCallback callback) {
       HttpClient.getInstance().get("Zlive.getSDK", LiveHttpConsts.GET_LIVE_SDK)
                .params("uid",CommonAppConfig.getInstance().getUid())
                .execute(callback);
    }
    ...
    public static void getTxLinkMicAccUrl(String originStreamUrl, HttpCallback callback) {
       HttpClient.getInstance().get("Zlinkmic.RequestPlayUrlWithSignForLinkMic", LiveHttpConsts.GET_TX_LINK_MIC_ACC_URL)
                .params("uid",CommonAppConfig.getInstance().getUid())
    ...
    public static void linkMicTxMixStream(String mergeparams, HttpCallback callback) {
        HttpClient.getInstance().post("Zlinkmic.MergeVideoStream", LiveHttpConsts.LINK_MIC_TX_MIX_STREAM)
                .params("uid",CommonAppConfig.getInstance().getUid())
    ...
    public static void anchorCheckLive(String liveUid, String stream, HttpCallback callback) {
       HttpClient.getInstance().get("Zlive.checkLiveing", LiveHttpConsts.ANCHOR_CHECK_LIVE)
                .params("uid",CommonAppConfig.getInstance().getUid())
                .params("token",CommonAppConfig.getInstance().getToken())
                .params("liveuid", liveUid)
                .params("stream", stream)
    ...
    public static void getLiveInfo(String liveUid, HttpCallback callback) {
       HttpClient.getInstance().get("Zlive.getLiveInfo", LiveHttpConsts.GET_LIVE_INFO)
                .params("liveuid", liveUid)
                .execute(callback);
    }
    ...
    public static void setLiveGoodsShow(String goodsid, HttpCallback callback) {
       HttpClient.getInstance().get("Zlive.setLiveGoodsIsShow", LiveHttpConsts.SET_LIVE_GOODS_SHOW)
                .params("uid",CommonAppConfig.getInstance().getUid())
                .params("token",CommonAppConfig.getInstance().getToken())
                .params("goodsid", goodsid)
                .execute(callback);
    ...
    public static void dailyTaskShareLive() {
       HttpClient.getInstance().get("Zlive.shareLiveRoom", LiveHttpConsts.DAILY_TASK_SHARE_LIVE)
                .params("uid",CommonAppConfig.getInstance().getUid())
                .params("token",CommonAppConfig.getInstance().getToken())
    ...
    public static void applyVoiceLiveMic(String stream, HttpCallback callback) {
       HttpClient.getInstance().get("Zlive.applyVoiceLiveMic", LiveHttpConsts.APPLY_VOICE_LIVE_MIC)
                .params("uid",CommonAppConfig.getInstance().getUid())
                .params("token",CommonAppConfig.getInstance().getToken())
                .params("stream", stream)
                .execute(callback);
    ...
    public static void cancelVoiceLiveMic(String stream, HttpCallback callback) {
       HttpClient.getInstance().get("Zlive.cancelVoiceLiveMicApply", LiveHttpConsts.CANCEL_VOICE_LIVE_MIC)
                .params("uid",CommonAppConfig.getInstance().getUid())
                .params("token",CommonAppConfig.getInstance().getToken())
                .params("stream", stream)
                .execute(callback);
    ...
    public static void getVoiceMicApplyList(String stream, HttpCallback callback) {
       HttpClient.getInstance().get("Zlive.getVoiceMicApplyList", LiveHttpConsts.GET_VOICE_MIC_APPLY_LIST)
                .params("uid",CommonAppConfig.getInstance().getUid())
                .params("token",CommonAppConfig.getInstance().getToken())
                .params("stream", stream)
                .execute(callback);
    ...
    public static void userDownVoiceMic(String stream, HttpCallback callback) {
       HttpClient.getInstance().get("Zlive.userCloseVoiceMic", LiveHttpConsts.USER_DOWN_VOICE_MIC)
                .params("uid",CommonAppConfig.getInstance().getUid())
                .params("token",CommonAppConfig.getInstance().getToken())
                .params("stream", stream)
                .execute(callback);
    ...
    public static void handleVoiceMicApply(String stream, String applyUid, int status, HttpCallback callback) {
       HttpClient.getInstance().get("Zlive.handleVoiceMicApply", LiveHttpConsts.HANDLE_VOICE_MIC_APPLY)
                .params("uid",CommonAppConfig.getInstance().getUid())
                .params("token",CommonAppConfig.getInstance().getToken())
                .params("stream", stream)
    ...
    public static void getVoiceControlList(String stream, HttpCallback callback) {
       HttpClient.getInstance().get("Zlive.anchorGetVoiceMicList", LiveHttpConsts.GET_VOICE_CONTROL_LIST)
                .params("uid",CommonAppConfig.getInstance().getUid())
                .params("token",CommonAppConfig.getInstance().getToken())
                .params("stream", stream)
                .execute(callback);
    ...
    public static void banEmptyMicPosition(String stream, int position, int status, HttpCallback callback) {
       HttpClient.getInstance().get("Zlive.changeVoiceEmptyMicStatus", LiveHttpConsts.BAN_EMPTY_MIC_POSITION)
                .params("uid",CommonAppConfig.getInstance().getUid())
                .params("token",CommonAppConfig.getInstance().getToken())
                .params("stream", stream)
    ...
    public static void changeVoiceMicOpen(String stream, int position, int status, HttpCallback callback) {
       HttpClient.getInstance().get("Zlive.changeVoiceMicStatus", LiveHttpConsts.CHANGE_VOICE_MIC_OPEN)
                .params("uid",CommonAppConfig.getInstance().getUid())
                .params("token",CommonAppConfig.getInstance().getToken())
                .params("stream", stream)
                .params("position", position)
    ...
    public static void closeUserVoiceMic(String stream, String toUid, HttpCallback callback) {
       HttpClient.getInstance().get("Zlive.closeUserVoiceMic", LiveHttpConsts.CLOSE_USER_VOICE_MIC)
                .params("uid",CommonAppConfig.getInstance().getUid())
                //.params("token",CommonAppConfig.getInstance().getToken())
                .params("stream", stream)
                .params("touid", toUid)
    ...
    public static void getVoiceMicStream(String stream, HttpCallback callback) {
       HttpClient.getInstance().get("Zlive.getVoiceMicStream", LiveHttpConsts.GET_VOICE_MIC_STREAM)
                .params("uid",CommonAppConfig.getInstance().getUid())
                .params("token",CommonAppConfig.getInstance().getToken())
                .params("stream", stream)
                .execute(callback);
    ...
    public static void getVoiceLivePullStreams(String stream, HttpCallback callback) {
       HttpClient.getInstance().get("Zlive.getVoiceLivePullStreams", LiveHttpConsts.GET_VOICE_LIVE_PULL_STREAMS)
                .params("uid",CommonAppConfig.getInstance().getUid())
                .params("token",CommonAppConfig.getInstance().getToken())
                .params("stream", stream)
                .execute(callback);
    ...
    public static void getHot(int p, HttpCallback callback) {
        HttpClient.getInstance().get("Home.getHotLive", LiveHttpConsts.GET_HOT)
                .params("uid",CommonAppConfig.getInstance().getUid())
                .params("p", p)
                .execute(callback);
    }
    ...
    public static void getClassLive(int classId, int p, HttpCallback callback) {
        HttpClient.getInstance().get("Home.getClassLive", LiveHttpConsts.GET_CLASS_LIVE)
