...
public class LiveRoomCheckLivePresenter {
    ...
    private void enterLiveRoom() {
        if (mActionListener != null) {
            mActionListener.onLiveRoomChanged(mLiveBean, mLiveType, mLiveTypeVal, Constants.LIVE_SDK_TX, mIsVoiceRoom);
        }
    }


    public interface ActionListener {
        void onLiveRoomChanged(LiveBeanReal liveBean, int liveType, int liveTypeVal, int liveSdk, boolean isVoiceRoom);
    }
}
