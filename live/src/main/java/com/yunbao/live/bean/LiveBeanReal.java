...
public class LiveBeanReal implements Parcelable {
    private String uid;
    ...
    private LiveBeanReal(Parcel in) {
    ...
    public static final Creator<LiveBeanReal> CREATOR = new Creator<LiveBeanReal>() {
        @Override
        public LiveBeanReal[] newArray(int size) {
            return new LiveBeanReal[size];
        }

        @Override
        public LiveBeanReal createFromParcel(Parcel in) {
            return new LiveBeanReal(in);
        }
    };
