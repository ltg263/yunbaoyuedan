...
public class ChatListViewHolder extends AbsViewHolder2 implements View.OnClickListener, ImListAdapter.ActionListener {
    ...
    public void init() {
        ...
        mSystemMsgContent = headView.findViewById(R.id.msg_sys);
        ...
        if (mType == TYPE_ACTIVITY) {
            ...
            headView.findViewById(R.id.view_order_msg).setVisibility(View.GONE);
        ...
        mSystemMsgCallback = new HttpCallback() {
            ...
            public void onSuccess(int code, String msg, String[] info) {
                ...
                if (code == 0 && info.length > 0) {
                    ...
                    if (mSystemTime != null) {
                        mSystemTime.setText(bean.getTime());
                    }
